...
function writeRuntimeStub(filePath) {
  (0, import_fs.writeFileSync)(filePath, RUNTIME_STUB_CONTENT);
}
...
var FileManager = class _FileManager {
  ...
  getParsedPackageJson(workspace) {
    ...
    const resolveDynamicPattern = /* @__PURE__ */ __name(() => {
      ...
      workspaces.forEach((item, index) => {
        const fields = {
          ...
          ...JSON.parse((0, import_fs2.readFileSync)(workspaces[index], "utf8"))
        };
        jsons.push(fields);
      });
      return jsons;
    ...
    const resolveStaticWorkspaces = /* @__PURE__ */ __name(() => {
      ...
      if (!(0, import_fs2.existsSync)(workspacePackageJsonPath)) {
        console.warn(`\u26A0\uFE0F  [cds-ts-dispatcher] Workspace '${workspace}' has no package.json on disk; skipped.`);
        return [];
      }
      const fields = {
        path: path2,
        ...JSON.parse((0, import_fs2.readFileSync)(workspacePackageJsonPath, "utf8"))
      };
      return [
        fields
      ];
  ...
  createFolderIfAbsent(folderPath) {
    if (!(0, import_fs2.existsSync)(folderPath)) {
      (0, import_fs2.mkdirSync)(folderPath, {
        recursive: true
      });
    }
  }
  createFileIfAbsent(filePath, defaultContent = "") {
    if (!(0, import_fs2.existsSync)(filePath)) {
      (0, import_fs2.writeFileSync)(filePath, defaultContent);
    }
  }
  ...
  appendLineIfAbsent(filePath, line) {
    ...
    if (!content.includes(line)) {
      (0, import_fs2.appendFileSync)(filePath, `
${line}
`);
    }
  }
  ...
  updatePackageJsonImports(filePath) {
    if ((0, import_fs2.existsSync)(filePath)) {
      const json = JSON.parse((0, import_fs2.readFileSync)(filePath, "utf8"));
      json.imports = json.imports || {};
      if (!json.imports["#dispatcher"]) {
        json.imports["#dispatcher"] = "./@dispatcher/index.js";
        (0, import_fs2.writeFileSync)(filePath, JSON.stringify(json, null, 2));
      }
    }
  }
  /**
  ...
  */
  updateTsconfigInclude(filePath) {
    ...
    const tsconfigContent = (0, import_fs2.readFileSync)(filePath, "utf8");
    const errors = [];
    ...
    const edits = Array.isArray(tsconfig.include) ? (0, import_jsonc_parser.modify)(tsconfigContent, [
      "include",
      -1
    ], "./@dispatcher", formatting) : (0, import_jsonc_parser.modify)(tsconfigContent, [
      "include"
    ], [
      "./@dispatcher"
    ], formatting);
    (0, import_fs2.writeFileSync)(filePath, (0, import_jsonc_parser.applyEdits)(tsconfigContent, edits));
  }
  ...
  run() {
    ...
    if (!(0, import_fs2.existsSync)(rootPackageJsonPath)) {
...
var EnvGenerator = class {
  ...
  */
  acquireEnvProgrammatically(executedInstalledPath, dispatcherPath) {
    ...
    try {
      ...
      if (!(0, import_fs3.existsSync)(transportFile)) {
        return {
          ok: false,
      ...
      return this.parseEnv((0, import_fs3.readFileSync)(transportFile, "utf8"), "programmatic `@sap/cds` env probe");
    } finally {
  ...
  */
  removeTransportFile(transportFile) {
    try {
      if ((0, import_fs3.existsSync)(transportFile)) {
        (0, import_fs3.rmSync)(transportFile);
      }
    } catch {
    }
  }
...
`;
    (0, import_fs3.writeFileSync)(filePath, fileContent);
  }
  /**
