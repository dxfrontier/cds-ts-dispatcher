...
export const constants = {
  DECORATOR: {
    ...
    GET_QUERY_PROPERTY: Symbol('GET_QUERY_PROPERTY'),
    GET_REQUEST_PROPERTY: Symbol('GET_QUERY_PROPERTY'),
    REQUEST: Symbol('REQUEST'),
    RESULTS: Symbol('RESULTS'),
    NEXT_FUNCTION: Symbol('NEXT_FUNCTION'),
    ERROR: Symbol('ERROR'),
  },
  ...
  MESSAGES: {
    ...
    UNSUPPORTED_DECORATOR_ACTIONS:
      "@IsPresent() / @GetQueryProperty does not support 'INSERT', 'DELETE', 'DROP', 'CREATE'",
  },
};
