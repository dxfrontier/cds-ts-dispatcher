...
module.exports.Publishers = createEntityProxy(['sap.capire.bookshop', 'Publishers'], {
...
module.exports.BookOrders = createEntityProxy(['sap.capire.bookshop', 'BookOrders'], {
  target: { is_singular: false },
});
// BookRecommendations
module.exports.BookRecommendation = createEntityProxy(['sap.capire.bookshop', 'BookRecommendations'], {
  target: { is_singular: true },
});
module.exports.BookRecommendations = createEntityProxy(['sap.capire.bookshop', 'BookRecommendations'], {
  target: { is_singular: false },
});
// BookFormats
module.exports.BookFormat = createEntityProxy(['sap.capire.bookshop', 'BookFormats'], {
  target: { is_singular: true },
});
module.exports.BookFormats = createEntityProxy(['sap.capire.bookshop', 'BookFormats'], {
  target: { is_singular: false },
});
// Books.texts
