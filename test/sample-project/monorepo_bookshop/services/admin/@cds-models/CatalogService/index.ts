  ...
  return class BookStat extends Base {
    ...
    declare static readonly actions: {
      GenerateReport: {
        ...
        // metadata (do not use)
        __parameters: { ID?: __.Key<__.DeepRequired<Book>['ID']> };
        __returns: {
          book?: __.DeepRequired<Book>['title'] | null;
          stats?: __.DeepRequired<BookStat>['views'] | null;
          rating?: __.DeepRequired<BookStat>['averageRating'] | null;
      ...
      NotifyAuthor: {
        ...
        // metadata (do not use)
        __parameters: { ID?: __.Key<__.DeepRequired<Author>['ID']> };
        __returns: boolean;
        kind: 'function';
      };
    };
...
export declare const changeBookProperties: {
  ...
  (
    ...
    language: __.DeepRequired<BookFormat>['language'] | null,
  ):
    | globalThis.Promise<{
...
export declare const submitOrder: {
  // positional
  (
    book: __.Key<__.DeepRequired<Book>['ID']>,
    ...
    | null;
  // named
  ({ book, quantity }: { book?: __.Key<__.DeepRequired<Book>['ID']>; quantity?: number | null }):
    | globalThis.Promise<{
        stock?: number | null;
      } | null>
    | {
    ...
    | null;
  // metadata (do not use)
  __parameters: { book?: __.Key<__.DeepRequired<Book>['ID']>; quantity?: number | null };
  __returns:
    | globalThis.Promise<{
        stock?: number | null;
      } | null>
