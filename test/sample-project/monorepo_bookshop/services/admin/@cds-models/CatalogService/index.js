...
// BookRecommendations
module.exports.BookRecommendation = createEntityProxy(['CatalogService', 'BookRecommendations'], {
  target: { is_singular: true },
});
module.exports.BookRecommendations = createEntityProxy(['CatalogService', 'BookRecommendations'], {
