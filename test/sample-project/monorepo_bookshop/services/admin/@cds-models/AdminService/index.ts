...
export class Promotion extends _PromotionAspect(__.Entity) {
  static drafts: __.DraftOf<Promotion>;
}
...
export class Promotions extends Array<Promotion> {
  static drafts: __.DraftsOf<Promotion>;
  $count?: number;
}
...
export declare const sendMail: {
  ...
  }): globalThis.Promise<_.HelloResponse | null> | _.HelloResponse | null;
  // metadata (do not use)
  __parameters: { request?: _.HelloRequest | null };
  __returns: globalThis.Promise<_.HelloResponse | null> | _.HelloResponse | null;
  kind: 'action';
};
