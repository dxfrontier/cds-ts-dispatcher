...
// UserActivityLog
module.exports.UserActivityLog = createEntityProxy(['AdminService', 'UserActivityLog'], {
  target: { is_singular: true },
});
module.exports.UserActivityLog_ = createEntityProxy(['AdminService', 'UserActivityLog'], {
