...
export declare const submitOrder: {
  ...
  __parameters: { book: __.DeepRequired<Book>['ID']; quantity: number };
  __returns: {
    stock?: number;
  };
};
...
export declare const sendMail: {
  (request: _.HelloRequest): _.HelloResponse;
  __parameters: { request: _.HelloRequest };
  __returns: _.HelloResponse;
};
